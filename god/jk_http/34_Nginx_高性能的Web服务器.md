...
<center><img src="https://ning-wang.oss-cn-beijing.aliyuncs.com/blog-imags/c5df0592cc8aef91ba961f7fab5a4a0b.png" alt="unpreview" style="zoom:50%;" /></center>
...
你也许听说过，Nginx是个<span class="orange">“轻量级”的Web服务器</span>
...
<center><img src="https://ning-wang.oss-cn-beijing.aliyuncs.com/blog-imags/3e94fbd78ed043e88c443f6416f99dc1.png" style="zoom:80%;" /></center>
...
<center><img src="https://ning-wang.oss-cn-beijing.aliyuncs.com/blog-imags/4c6832cdce34133c9ed89237fb9d5059.png" style="zoom:80%;" /></center>
...
<center><img src="https://ning-wang.oss-cn-beijing.aliyuncs.com/blog-imags/41318c867fda8a536d0e3db6f9987030.png" style="zoom:80%;" /></center>
...
1. <span class="orange">Nginx是一个高性能的Web服务器，它非常的轻量级，消耗的CPU、内存很少；</span>

2. <span class="orange">Nginx采用“master/workers”进程池架构，不使用多线程，消除了进程、线程切换的成本；</span>

3. <span class="orange">Nginx基于epoll实现了“I/O多路复用”，不会阻塞，所以性能很高；</span>

4. <span class="orange">Nginx使用了“职责链”模式，多个模块分工合作，自由组合，以流水线的方式处理HTTP请求。</span>
...
<center><img src="https://ning-wang.oss-cn-beijing.aliyuncs.com/blog-imags/4c7bceb80a8027389705e9d6ec9eb43d.png" alt="unpreview" style="zoom:33%;" /></center>
