...
<center><img src="https://ning-wang.oss-cn-beijing.aliyuncs.com/blog-imags/e8369d077454e5b92e3722e7090551a3.png" style="zoom: 80%;" /></center>
...
这里我就要“隆重”介绍一下WAF领域里的最顶级产品了：<span class="orange">ModSecurity</span>，它可以说是WAF界“事实上的标准”。
...
<center><img src="https://ning-wang.oss-cn-beijing.aliyuncs.com/blog-imags/add929f8439c64f29db720d30f7de548.png" style="zoom:50%;" /></center>
...
1. <span class="orange">Web服务通常都运行在公网上，容易受到“DDoS”、“代码注入”等各种黑客攻击，影响正常的服务，所以必须要采取措施加以保护；</span>

2. <span class="orange">WAF是一种“HTTP入侵检测和防御系统”，工作在七层，为Web服务提供全面的防护；</span>

3. <span class="orange">ModSecurity是一个开源的、生产级的WAF产品，核心组成部分是“规则引擎”和“规则集”，两者的关系有点像杀毒引擎和病毒特征库；</span>

4. <span class="orange">WAF实质上是模式匹配与数据过滤，所以会消耗CPU，增加一些计算成本，降低服务能力，使用时需要在安全与性能之间找到一个“平衡点”。</span>
...
<center><img src="https://ning-wang.oss-cn-beijing.aliyuncs.com/blog-imags/b9e48b813c98bb34b4b433b7326ace24.png" alt="unpreview" style="zoom:33%;" /></center>
